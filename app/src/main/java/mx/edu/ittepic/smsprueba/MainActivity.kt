package mx.edu.ittepic.smsprueba
...
class MainActivity : AppCompatActivity() {
    ...
    fun mandar(tel: String, msj: String){
        ...
        try {
            ...
            if (Build.VERSION.SDK_INT>=23) { smsManager = SmsManager.getDefault()}
            else{ smsManager = SmsManager.getDefault()
               // smsManager= SmsManager.this.getSystemService(SmsManager::class.java)
            }
